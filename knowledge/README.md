...
Khi nghiên cứu topic mới qua orchestrator skill (`appsec-research-orchestrator`):
1. Dedup search trong `knowledge/` (bước pre-flight bắt buộc)
2. Resolve `category` từ bảng domain trên
3. Output theo template 12 section — xem [`docs/appsec-research-pipeline/README.md`](../docs/appsec-research-pipeline/README.md)
